...
amenityGroups: [
  ...
  thingsToKnow: [
    {
      ...
      lines: [
        "Free cancellation before 19 October. Cancel before check-in on 20 October for a partial refund.",
    ...
    },
    {
      icon: "key-round",
      title: "House rules",
      lines: ["Check-in after 2:00 pm", "Checkout before 11:00 am", "5 guests maximum"],
      linkLabel: "Learn more",
    },
    {
      icon: "shield",
  ...
  nearbyStays: [
    { title: "The Tropical Studio | 5 mins to Beach", price: 22824, rating: 4.96, image: img("More1.png") },
    { title: "Greentique Luxury Flat with plunge pool, Calangute", price: 29942, rating: 4.5, image: img("More2.png") },
    { title: "Beautiful Studio with a view to die for", price: 15648, rating: 5.0, image: img("More3.png") },
    { title: "Luxury Apt | Private Pool | 6 Mins from Beach", price: 48786, rating: 4.93, image: img("More4.png") },
    { title: "NAQAB - 1bhk with private pool", price: 23824, rating: 4.3, image: img("More5.png") },
    { title: "Serendipity Cottage - Calm Stay in Calangute-Baga.", price: 22824, rating: 4.92, image: img("More6.png") },
    { title: "Kanso by Earthen Window | Jacuzzi | Terrace | Pool", price: 45648, rating: 5.00, image: img("More7.png") },
    { title: "Luxury Apt | Private Pool | 6 Mins from Beach", price: 48786, rating: 4.93, image: img("More8.png") },
  ],
};
