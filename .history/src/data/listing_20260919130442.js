...
export const listing = {
  ...
  amenityGroups: [
     {
      title: "Bathroom",
      items: [
        { icon: "car", label: "Hairdryer" },
        { icon: "waves", label: "Cleaning products" },
        { icon: "flame", label: "Shampoo" },
        { icon: "dumbbell", label: "Hot water" },
        { icon: "dumbbell", label: "Shower gel" }
      ],
    },
    {
  ...
  nearbyStays: [
    { title: "The Tropical Studio | 5 mins to Beach", price: 22824, rating: 4.96, image: img1("nearby-1") },
